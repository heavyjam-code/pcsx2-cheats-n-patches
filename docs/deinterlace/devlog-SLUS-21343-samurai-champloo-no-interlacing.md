...
- **The smear.** The game looks like it also runs a frame-feedback filter, the same family
  as the ones removed for
  [GitS SAC](../deblur/devlog-SLUS-21006-gits-sac-remove-blur.md) and
  [Cowboy Bebop](../deblur/devlog-SLPS-25550-cowboy-bebop-remove-blur.md). That is a
  separate group and a separate devlog; this patch does not touch it.
