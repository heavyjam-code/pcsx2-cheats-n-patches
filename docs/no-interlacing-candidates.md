...
5. **Respect the CSR.FIELD trap.** If the game polls CSR bit 13, telling it that it is progressive deadlocks the boot. Patch output constants only. This is [attempt 1 of the Ys V devlog](devlog-SLPM-66360-ys-v-no-interlacing.md).
